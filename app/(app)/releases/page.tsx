...
// - 卡片形式:顶部版本号 + 重要红点 + 发布时间;中部 title + summary;详情折叠可展开
              ...
              return (
                ...
                >
                  ...
                  >
                    ...
                    <Tag color="blue" style={{ margin: 0, fontFamily: "ui-monospace, monospace" }}>
                      {r.version}
                    </Tag>
                  ...
                  <div style={{ marginTop: 4 }}>
                    <Button
                      ...
                      onClick={() => toggle(r.id)}
                    >
                      {isOpen ? t("releases.history.collapse") : t("releases.history.expand")}
                    </Button>
                  </div>
                </div>
              );
