...
export default function OverviewPage() {
  ...
  const kpis: StatItem[] = [
    { label: "合同额", value: currency(o?.contractAmount ?? 0), prefix: "¥", description: `共 ${o?.contractCount ?? 0} 份`, tone: "info" },
    { label: "已开票额", value: currency(o?.invoiceAmount ?? 0), prefix: "¥", description: `开票率 ${o?.invoiceRate ?? 0}%`, tone: "accent" },
    { label: "已回款额", value: currency(o?.paymentAmount ?? 0), prefix: "¥", description: `回款率 ${o?.paymentRate ?? 0}%`, tone: "success" },
    { label: "未回款额", value: currency(o?.unpaidAmount ?? 0), prefix: "¥", description: "应收账款余额", tone: "danger" }
  ];
